...
_GUARDRAILS = (
    ...
    "- ALLOW any request that maps to a tool, regardless of topic:\n"
    "  - 'generate a survey about mumps' → generate_survey (allowed)\n"
    "  - 'find personas for a healthcare company' → find_personas (allowed)\n"
    "  - 'what do my docs say about cancer research' → ask_question (allowed)\n"
