...
QUESTION_TYPE_PROMPTS: Dict[str, str] = {
    ...
    "tree_testing": (
        ...
        "those exact terms.\n"
        "- BANNED LABELS (hard fail — do NOT use any of these, even with "
        "numbers appended): 'Sub option', 'Sub item', 'Suboption', "
        "'Subitem', 'Sub-option', 'Sub-item', 'Option 1/2/3', 'Item 1/2/3', "
        "'Category 1/2/3', 'Section 1/2/3', 'Sub-category', 'Subcategory', "
        "'Child 1/2/3', 'Placeholder', 'Example', 'Feature A/B/C', "
        "'Product 1/2', 'Service A/B'. If you find yourself writing these, "
        "STOP and pull a real term from the KB context.\n"
        "- If the KB context is thin, INVENT plausible realistic labels for "
        "the company's industry (e.g., 'Billing', 'Team Settings', 'API "
        "Docs') — but still no placeholders.\n"
