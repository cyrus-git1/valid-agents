...
INTENT_CLASSIFICATION_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "- persona: user wants to discover, identify, or build audience personas or customer segments\n"
        "- enrich: user wants to enrich, augment, or fill gaps in the knowledge base with external web data\n"
