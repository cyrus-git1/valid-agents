...
PLAN_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "  extend_survey    — Add N more questions to an EXISTING survey using the original prompt + same KB context\n"
        ...
        "  'add 3 more questions' / 'extend this survey' / 'give me 5 more' → "
        "extend_survey (needs the original prompt + existing questions)\n"
