...
QUESTION_TYPE_PROMPTS: Dict[str, str] = {
    ...
    "matrix": (
        ...
        "- CRITICAL: Row labels MUST reference the company's actual products, services, "
        "features, or specific aspects from the knowledge base context. Do NOT use generic "
        "rows like 'Product Quality' or 'Customer Service'. Use the specific offerings, "
        "features, and terminology mentioned in the context "
        "(e.g., 'Pricing Intelligence Workflow', 'Dynamic Survey Design', 'AI Analysis')\n"
        "- Column labels should form a coherent scale appropriate to what's being measured\n"
